...
toplot = cat(2,  group(idx)', m(idx)', sd(idx)', b0(idx)');
...
gscatter(m, 1:length(m), group, [c_color; a_color], '.', 20)
hold on;
gscatter(b0, 1:length(b0), group, [c_color; a_color], 'x', 8)
plot([20 20], [0 56], ':k')
