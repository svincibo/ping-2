...
measure = 'thickness'; % 'fa', 'volume', 'gmd', 'md'
...
if strcmp(save_figures, 'yes')
    ...
    print(fullfile(rootDir, 'plots', ['plot_fig3_cm_' measure '_' hemisphere]), '-dpng')
    print(fullfile(rootDir, 'plots', 'eps', ['plot_fig3_cm_' measure '_' hemisphere]), '-depsc')
